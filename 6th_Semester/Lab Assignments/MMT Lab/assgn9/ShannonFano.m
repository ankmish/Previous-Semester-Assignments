...
% p1 should be a probability vector 
% code1 outputs the corresponding codewords (obtained by Shannon-Fano coding)
...
lengthss = cellfun(@length, code1);
average_length = sum(lengthss.*p1);
end
